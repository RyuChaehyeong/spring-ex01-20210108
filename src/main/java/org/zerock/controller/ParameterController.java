...
import org.zerock.domain.CustomerBookEditor;
...
public class ParameterController {
	...
	//parameter이름과 parameter가 같은 경우 생략가능
	@RequestMapping("/ex3")
	...
	public void initBinder1(WebDataBinder binder) {
		...
		//request parameter를 requiredType로 변경시킬 때 propertyEditor를 사용
		//binder.registerCustomEditor(requiredType, propertyEditor);
		binder.registerCustomEditor(Book.class, new CustomerBookEditor());
